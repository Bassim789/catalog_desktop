...
catalog.load(data.current_variables)
catalog.add_main_info(data.main_info[0])
catalog.add_tables_data(data.tables)
catalog.add_databases_data(data.databases)
catalog.set_variables()
catalog.set_tables()
catalog.set_databases()
catalog.add_modalities_data(data.current_modalities)
